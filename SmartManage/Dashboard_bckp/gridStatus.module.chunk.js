...
var GridStatusComponent = (function () {
    ...
    GridStatusComponent.prototype.getKpiData = function () {
        ...
        sheet.getUnderlyingDataAsync(options).then((function (t) {
            ...
            var gridStatusURL = 'https://reporting.cyient.com/t/UGNAMPOC/views/GridStatus/FeederGridstatus?:embed=y&:showAppBanner=false&:showShareOptions=true&:display_count=no&:showVizHome=no&:toolbar=no';
            var options = {
                hideTabs: true,
                width: '100%',
                height: '25vh',
    ...
    GridStatusComponent.prototype.viewSummary = function () {
        ...
        var summaryUrl = 'https://reporting.cyient.com/t/UGNAMPOC/views/summary/FeederGridSummary?:embed=y&:showAppBanner=false&:showShareOptions=true&:display_count=no&:showVizHome=no&:toolbar=no';
    ...
    GridStatusComponent.prototype.getGridWiseCompletion = function () {
        ...
        var completionUrl = 'https://reporting.cyient.com/t/UGNAMPOC/views/gridWiseCompletion/GridwiseCompletionStatus?:embed=y&:showAppBanner=false&:showShareOptions=true&:display_count=no&:showVizHome=no&:toolbar=no';
        //var url = 'https://reporting.cyient.com/t/UGNAMPOC/views/GridHistory/Dashboard1?:embed=y&:showAppBanner=false&:showShareOptions=true&:display_count=no&:showVizHome=no&:toolbar=no';
        var options = {
            hideTabs: true,
            width: '100%',
    ...
    GridStatusComponent.prototype.ngOnInit = function () {
        ...
        var url = 'https://reporting.cyient.com/t/UGNAMPOC/views/FeederStatus/FeederStatus?:embed=y&:showAppBanner=false&:showShareOptions=true&:display_count=no&:showVizHome=no&:toolbar=no';
        //var url = 'https://reporting.cyient.com/t/UGNAMPOC/views/GridHistory/Dashboard1?:embed=y&:showAppBanner=false&:showShareOptions=true&:display_count=no&:showVizHome=no&:toolbar=no';
        var options = {
            hideTabs: true,
            width: '100%',
    ...
    GridStatusComponent.prototype.ngOnDestroy = function () {
        ...
        this.tCompletionViz != undefined ? this.tCompletionViz.dispose() : "";
    };
