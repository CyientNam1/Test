...
var AuthenticationService = (function () {
    ...
    AuthenticationService.prototype.getToken = function () {
        var _this = this;
        var url = 'http://localhost:8088/tableauSecurity';
        var postHeaders = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]({ 'Content-Type': 'application/json', 'cyient-access-token': localStorage.getItem('access-token') });
        return this.http.post(url, JSON.stringify({ username: 'Utilities_NAM' }), { headers: postHeaders }).map(function (response) {
    ...
    AuthenticationService.prototype.getTableauToken = function () {
        $.ajax({
            url: 'http://localhost:8088/tableauSecurity',
            type: 'POST',
            data: {
                username: 'Utilities_NAM'
            },
            ...
            headers: {
                "Content-Type": "application/x-www-form-urlencoded",
                'cyient-access-token': localStorage.getItem('access-token')
            },
            success: function (data) {
                sessionStorage.setItem('tableauTokenId', data);
            },
