    ...
    var clazz = declare([BaseWidget], {
      ...
      postCreate: function() {
        ...
        this.own(on(this.widgetManager, 'widget-destroyed', lang.hitch(this, function(widgetId) {
          if(widgetId && widgetId.indexOf('Search') >= 0) {
            this.resize();
          }
        })));
      ...
      startup: function() {
        ...
        if (this.appConfig.about) {
         ...
         dojo.byId('lbluser').innerHTML = sessionStorage.getItem('loginUser');
      ...
      _updateBoxsizes: function() {
        ...
        html.setStyle(this.titlesNode, 'width', (titleBox.w + subTitleBox.w + 2) + 'px');

        var searchWidgetBox = {l: 0, t: 0, w: 0, h: 0};
        var LinksIconBox = {l: 0, t: 0, w: 0, h: 0}; // "w:10": leave some space to the edge
      ...
      resize: function() {
        ...
        if(window.appInfo.isRunInMobile){
          ...
          if(15 + contentWidth + offsetRight < winBox.w) {  // enough space to show everything
            ...
            this.titleNode.style.visibility = 'visible';
            ...
            if(15 + contentWidth - boxSizes.subTitleBox.w + offsetRight < winBox.w) {
              ...
              this.titleNode.style.visibility = 'hidden';
              this.subtitleNode.style.visibility = 'hidden';
            }
          }
        }
