...
define([
  ...
  function (declare, lang, array, html, on, Deferred, editUtils,
    ...
    var Clazz = declare([_WidgetBase, _TemplatedMixin], {
      ...
      _createATI: function (operationData) {
        ...
        var handle = on(attributeInspector, 'attribute-change', lang.hitch(this, this._onAttributeChange, operationData));
        this._temporaryData.eventHandles.push(handle);
      ...
      _getDisplayTitleOfRelatedRecord: function (operationData, relatedRecord) {
        var displayTitle = editUtils.getAttrByFieldKey(relatedRecord,
          ...
          operationData.destJimuLayerInfo.layerObject.objectIdField);
            ...
            array.forEach(relatedRecords, function (relatedRecord, index) {
              ...
              */
              ...
              var recordItem = html.create('div', {
                ...
                innerHTML: displayTitle + ":" + relatedRecord.attributes.ID
              }, this.contentBox);
      ...
      _onDeleteBtnClick: function (operationData) {
        require(["dijit/ConfirmDialog"], lang.hitch(this, function (ConfirmDialog) {
