...
define([
    ...
    function (declare, lang, array, html, esriBundle, on, query, Json, Deferred, aspect, all,
        ...
        Extent, Point, Polygon, webMercatorUtils, geometryEngine, rendererJsonUtils, FeatureLayer, Query, Button, editUtils, FilterEditor, RelatedRecordsEditor, Dialog) {
        return declare([BaseWidget, _WidgetsInTemplateMixin], {
            ...
            startup: function () {
                ...
                queryTask = new esri.tasks.QueryTask("https://apigateway.cyient-fiops.com/server/rest/services/XCELADB/WFM_AOI_XCELADB/MapServer/0");
            ...
            showDialog: function(title, content) {
                var myDialog = new Dialog({
                    ...
                    content: "Your account does not have permission to create or modify data in this Grid , Please contact Administrator for this Grid Access",
                    style: "width: 300px"
                });
                myDialog.show();
            },
