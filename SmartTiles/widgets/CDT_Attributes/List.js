  ...
  function(declare,
    ...
    return declare([_WidgetBase, Evented], {
      ...
      startup: function() {
        ...
        //this._listContainer1 = domConstruct.create('div1');
        ...
        domConstruct.place(this._listContainer, this.domNode);
          //div1 
        //domClass.add(this._listContainer1, 'identify-list-container');
        //this.own(on(this._listContainer1, 'click', lang.hitch(this, this._onClick)));
        //this.own(on(this._listContainer1, 'mouseover', lang.hitch(this, this._onMouseOver)));
        //this.own(on(this._listContainer1, 'mouseout', lang.hitch(this, this._onMouseOut)));
        //domConstruct.place(this._listContainer1, this.domNode);
      },
      ...
      add: function(item) {
        ...
        if(document.all && !document.addEventListener){
          ...
          var mySurface = gfx.createSurface(iconDiv, 20, 20);
