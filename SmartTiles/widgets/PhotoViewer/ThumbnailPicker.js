...
define("dojox/image/ThumbnailPicker", ["dojo", "dijit", "dojox", "dojo/require!dojox/fx/scroll,dojo/fx/easing,dojo/fx,dijit/_Widget,dijit/_Templated"], function (_1, _2, _3) {
    ...
    _1.declare("dojox.image.ThumbnailPicker", [_2._Widget, _2._Templated], {
        imageStore: null,
        request: null,
        size: 500,
        thumbHeight: 75,
        ...
        pageSize: 20,
        titleAttr: "title",
        templateString: _1.cache("dojox.image", "resources/ThumbnailPicker.html", "<div dojoAttachPoint=\"outerNode\" class=\"thumbOuter\">\n\t<div dojoAttachPoint=\"navPrev\" class=\"thumbNav thumbClickable\">\n\t  <img src=\"\" dojoAttachPoint=\"navPrevImg\"/>    \n\t</div>\n\t<div dojoAttachPoint=\"thumbScroller\" class=\"thumbScroller\">\n\t  <div dojoAttachPoint=\"thumbsNode\" class=\"thumbWrapper\"></div>\n\t</div>\n\t<div dojoAttachPoint=\"navNext\" class=\"thumbNav thumbClickable\">\n\t  <img src=\"\" dojoAttachPoint=\"navNextImg\"/>  \n\t</div>\n</div>"),
        _thumbs: [],
        _thumbIndex: 0,
        _maxPhotos: 0,
        _loadedImages: {},
        ...
        setDataStore: function (_9, _a, _b) {
            ...
            this.request = {
                ...
                start: _a.start || 0,
                count: _a.count || 10,
                onBegin: _1.hitch(this, function (_c) {
                    this._maxPhotos = _c;
                })
            };
            if (_a.query) {
        ...
        _checkLoad: function (img, _20) {
            _1.publish(this.getShowTopicName(), [{
                index: _20
            }]);
            this._updateNavControls();
            this._loadingImages = {};
        ...
        _showThumbs: function (_21) {
            ...
            if (this.isScrollable) {
                ...
                _3.fx.smoothScroll({
                    ...
                    duration: 300,
                    easing: _1.fx.easing.easeOut,
                    onEnd: _1.hitch(this, "_checkLoad", img, _21)
                }).play(10);
            } else {
                if (this.isHorizontal) {
        ...
        _loadImage: function (_32, _33, _34) {
            ...
            var _36 = _1.create("div", {
                id: "img_" + this.id + "_" + _33,
            ...
            _1.connect(img, "onclick", this, function (evt) {
                _1.publish(this.getClickTopicName(), [{
                    index: evt.target._index,
                    data: evt.target._data,
                    url: img.getAttribute("src"),
                    largeUrl: this.imageStore.getValue(_32, this.imageLargeAttr),
                    title: this.imageStore.getValue(_32, this.titleAttr),
                    link: this.imageStore.getValue(_32, this.linkAttr)
                }]);
